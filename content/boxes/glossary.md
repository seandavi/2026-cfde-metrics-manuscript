...
The Glossary is part of the main manuscript document (not a
separate upload). Max 450 words. Alphabetical order. Format is
**Term**: explanation (term in bold, colon, definition not bold).
The glossary does not count toward the display-element limit.
First in-text occurrence of each glossed term should be set in
bold; the first one carries "(see glossary)" after it. Bolding the
first occurrences is a follow-up pass once the main text is final.
-->

::: {.callout-note title="Glossary"}
